...
: "${ADL1T_OUTPUT_ROOT:?Set ADL1T_OUTPUT_ROOT to the EOS/CERNBox output directory}"
: "${CODE_DIR:=/tmp/ADatL1}"
...
# Retained local example. The active command above replaces it.
# python3 src/train.py \
#     paths.raw_data_dir=../../03_Data/adl1t_data/parquet_files \
#     experiment=physics/ae \
#     run_name="Test_Probes_Run_2" \
#     logger=mlflow \
#     algorithm.optimizer.lr=0.0019859329798336714 \
#     algorithm.delta=1.0 \
