#!/usr/bin/env bash
# ========================================================================
# DeepSets AE HYPERPARAMETER SEARCH COMMANDS
# ========================================================================
...
#     logger=none \
#     hparams_search=physics/dsae_optuna \
...
#     paths.raw_data_dir=/path/to/adl1t_data/parquet_files \
#     experiment=physics/dsae_agnostic \
#     experiment_name=dsae_agnostic_consistency_vs_mse_b16k_search \
#     callbacks.anomaly_eff=null \
#     callbacks.thres_drift=null \
#     callbacks.wasserstein_dist=null \
#     callbacks.thres_drift_ema_ckpt=null \
...
#     hydra.sweeper.study_name=consistency_vs_mse_b16k \
#     hydra.sweeper.n_trials=100 \
#     hydra.sweeper.sampler.n_startup_trials=150 \
#     trainer=gpu \
#     trainer.max_epochs=50 \
