...
# Agnostic stability training. Skip the CAP computation every epoch to save time.
# taskset -c 6-8 \
# python3 src/train.py \
#     paths.raw_data_dir=/data/deodagiu/adl1t_data/parquet_files \
#     experiment=ae_agnostic \
...
#     run_name=stability_trial_7_low \
#     algorithm.optimizer.lr=0.0010961201836432106 \
#     algorithm.loss.delta=10.0 \
#     trainer.gradient_clip_val=2.0 \
#     algorithm.optimizer.betas='[0.9, 0.999]' \
#     algorithm.optimizer.weight_decay=1e-05 \
...
# Agnostic MSE-wasserstein training. Skip the CAP computation every epoch to save time.
# taskset -c 15-17 \
# python3 src/train.py \
#     paths.raw_data_dir=/data/deodagiu/adl1t_data/parquet_files \
#     experiment=ae_agnostic \
...
#     callbacks.cap_sn_zb_ema_ckpt=null \
#     ~evaluator.ckpts.summary.cap_ema_zerobias_vs_SingleNeutrino_E-10-gun \
#     run_name=wasserstein_trial_534_low \
#     algorithm.optimizer.lr=0.000653674170864778 \
