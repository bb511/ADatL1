...
class ImageDeepSVDD(ADLightningModule):
    """Deep SVDD module for image data.

    Learns a compact latent representation of normal images. The anomaly score is the
    squared Euclidean distance to a learned center in latent space.

    :param encoder: Image encoder network mapping image inputs to latent space.
