...
def log_plots_to_mlflow(
    trainer, ckpt_name: str, name: str, plot_folder: Path, make_gallery: bool = False
):
    ...
    arti_ckpt_dir = resolve_arti_dir(trainer, name, ckpt_name)
...
def resolve_arti_dir(trainer, name: str, ckpt_name: str = None):
    """Resolve the artifacts directory where the plots will be stored in mlflow."""
    arti_dir = Path()
    if trainer.strat_name:
        arti_dir = arti_dir / trainer.strat_name / name
