...
class Decoder(nn.Module):
    ...
    def __init__(
        ...
        if init_last_weight != None: init_last_weight(last_linear_layer.weight)
        if init_last_weight != None and last_linear_layer.bias != None: init_last_bias(last_linear_layer.bias)
